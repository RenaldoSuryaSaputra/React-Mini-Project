  ...
  return (
    <>
      <svg
        ...
        className="absolute block w-full top-0"
      ...
      <div className="md:mt-12 xl:mt-20 sm:mt-10">
        <div className="text-center text-gray-800">
          <div
            className="m-auto rounded-lg shadow-lg md:py-16 md:px-12 sm:py-4 sm:px-4 xl:w-2/3 md:w-2/3 sm:w-full"
            style={{
              backgroundColor: "hsla(0, 0%, 100%, 0.8)",
              backdropFilter: "saturate(200%) blur(25px)",
            }}
          >
            <h1 className="sm:text-3xl md:text-4xl xl:text-5xl font-bold tracking-tight mb-8 ">
              Temukan kebutuhan anda cari disini <br />
            </h1>
            <Link
              className="inline-block px-3 py-3 mb-2 md:mb-0 mr-0 md:mr-2 bg-blue-600 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
            ...
            <h1 className="text-md font-semibold tracking-tight xl:my-4 sm:my-2">
              Atau jadilah penjual sekarang juga
            </h1>
            <Link
              className="inline-block px-3 py-3 mb-2 md:mb-0 mr-0 md:mr-2 bg-blue-600 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
              data-mdb-ripple="true"
        ...
        <section className="mb-32 text-gray-800">
          <div className="flex justify-center">
            <div className="text-center lg:max-w-3xl md:max-w-xl">
              <h2 className="text-3xl font-bold mb-12 px-6">Hubungi Kami</h2>
            </div>
          </div>
              ...
              <div className="flex flex-wrap">
                <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                  <div className="flex items-start">
                    ...
                    <div className="grow ml-6">
                      <p className="font-bold mb-1">Dukungan teknis</p>
                ...
                <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                  <div className="flex align-start">
                    ...
                    <div className="grow ml-6">
                      <p className="font-bold mb-1">Pers</p>
                ...
                <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                  <div className="flex align-start">
                    ...
                    <div className="grow ml-6">
                      <p className="font-bold mb-1">Laporan bug</p>
